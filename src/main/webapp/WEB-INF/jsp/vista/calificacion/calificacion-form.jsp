...
<head>
	<meta charset="UTF-8">
	<title>Form. Calificaciones</title>
...
<body bgcolor="beige">
	...
	<section class="midBot bgc1 p-5">
		<div class="container">
			...
			<form method="POST" action="/JAVA-PEOPLE/CalificacionController">
				<input type="hidden" name="id" value="${calificacion.id}" />
				<div class="mb-3">
		  			<label for="nombre" class="form-label">Nombre :</label>
		  			<input type="text" class="form-control" value="${calificacion.nombreEvaluacion}" id="nombre" name="nombre" />
				</div>
