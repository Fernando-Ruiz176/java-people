	...
	<div class="container">
		...
		<form method="POST" action="/java-people/EstudianteController">
			...
			<div class="mb-3">
	  			...
	  			<input type="text" class="form-control" value="${estudiante.curso}" id="curso" name="curso" />
			</div>
			
			<button class="btn btn-primary" type="submit">Agregar</button>
			<a href="/java-people/EstudianteController?accion=listar" class="btn btn-primary">Mostrar</a>
